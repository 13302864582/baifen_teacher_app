...
public class CropImageView extends FrameLayout {
    ...
    public void rotateImage(int degrees ,String filePath) {
	...
	private  void saveFile(String filePath, Bitmap bitmap) {
		...
		bitmap = Bitmap.createScaledBitmap(bitmap, (width / scale),
				(height / scale), false);
		int ratio = 0;
		if (size > 1000) {// 超过1200k进行压缩
			ratio = 85;
		} else {
			ratio = 100;
		}
