...
public class SlidingDrawer extends RelativeLayout implements OnTouchListener, AnimatorListener {
	...
	public SlidingDrawer(Context context, AttributeSet attrs, int defStyleAttr,
		...
		mOrientation = a.getInt(R.styleable.SlidingDrawer_orientation_,
	...
	public void setsetDrawerOpen(boolean animate) {
		...
		mHandle.setBackgroundResource(R.drawable.turn_on);
	...
	public void setDrawerClosed(boolean animate) {
		...
		RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mContent.getLayoutParams();
		layoutParams.bottomMargin=DisplayUtils.dip2px(mcontext, 48);
		mContent.setLayoutParams(layoutParams);
		mHandle.setBackgroundResource(R.drawable.turn_down);
	}
