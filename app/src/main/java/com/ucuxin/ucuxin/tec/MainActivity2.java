 ...
 * @author: sky
 */
public class MainActivity2 extends BaseActivity implements HttpListener,OnClickListener, INetWorkListener, OnRefreshListener<ScrollView>, NavigationView.OnNavigationItemSelectedListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case HANDLER_HOME_CODE:
                    homeApi.getNoticeList(requestQueue, MainActivity2.this, RequestConstant.GET_NOTICE_LIST);
                    break;
                ...
                case SHOW_NOTICE:// 强制升级
                    ...
                    showNoticeDialog(MainActivity2.this,  true);
                    break;
                case SHOW_NOTICE_NOTFORCE:// 不强制升级
                    cloesNoticeDialog(noticeDialog);
                    showNoticeDialog(MainActivity2.this,  false);
                    break;
                case DOWN_UPDATE:
                    setResult();
                    break;
    ...
    public void initView() {
      ...
      /*  // 设置下拉加载
        ...
        String str = DateUtils.formatDateTime(MainActivity2.this, System.currentTimeMillis(),
    ...
    private void initToolbarToogle() {
        mDrawerToggle = new ActionBarDrawerToggle(MainActivity2.this,mDrawer,toolbar,R.string.drawer_open,R.string.drawer_close);
    ...
    public void onResume() {
        ...
        if (mainMessageController == null) {
            mainMessageController = new MainMessageController(null, MainActivity2.this);
        }
        showMessageList();
    }
    ...
    private void cleanUseInfo() {
        IntentManager.stopWService(MainActivity2.this);
        ...
        closeDialog();
        IntentManager.goToLogInView(MainActivity2.this);
            ...
            if (!TextUtils.isEmpty(response)) {
                ...
                if (code == 0) {
                    ...
                    if (!TextUtils.isEmpty(dataJson)) {
                        ...
                        GlideImageUtils.getInstance().loadAvatarWithActivity(MainActivity2.this,
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus) {
            if ((System.currentTimeMillis() - checkTime) > 600000) {
                if (NetworkUtils.getInstance().isInternetConnected(MainActivity2.this)) {
                    //检测升级
    ...
    private void showMessageList() {
        new MyAsyncTask() {
            ...
            public void doInBack() {
                if (!isDoInDB) {
                    isDoInDB = true;
                    MainActivity2.isShowPoint = false;
        ...
        switch (flag) {
            ...
            case -1:
                ...
                if (flag2 == RequestConstant.GET_HOMEPAGE_INFO_CODE) {
                    ...
                    final CustomTixianDialog dialog = new CustomTixianDialog(MainActivity2.this, errorStr);
                    dialog.show();
...
//                String msg = JsonUtils.getString(response, "Msg", "");
    ...
    public void showNoticeDialog(Context mContext,   boolean isYes) {
        if (mContext != null && !((Activity) mContext).isFinishing()) {
            noticeDialog = new CustomAppCheckUpdateDialog(MainActivity2.this, isYes);
            noticeDialog.show();
