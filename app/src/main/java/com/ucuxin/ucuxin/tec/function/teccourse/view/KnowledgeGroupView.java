...
public class KnowledgeGroupView extends LinearLayout {
    ...
    public KnowledgeGroupView(Context context, int horizontalSpacing, int verticalSpacing) {
        super(context);
    }

    public KnowledgeGroupView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (pos != null) {
            	...
            	LogUtils.e("KnowledgeGroupView", "error");
            }
        }
    }
