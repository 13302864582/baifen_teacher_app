...
public class DaihuidaAdapter extends BaseAdapter {
	...
	public DaihuidaAdapter(BaseActivity context, List<HomeworkListModel> list2) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.daihuida_list_item, parent, false);
